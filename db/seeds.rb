...
couloir_pissoir = Trip.new(name: "Couloir Pissoir", location: "Chamonix", subtitle: "A big adventure through some huge terrain", start_lat: 46.02054560000002, start_long: 6.970731, end_lat: 46.04632359999999, end_long: 6.994817599999999, kilometers: 15.1, duration: "5-6 hours", difficulty: 4, description: "This is a fantastic adventure through some big, wild mountains which culminates with an exciting and remote ski descent. The majority of the terrain the adventure passes through (on both the way up and down) is extremely serious, and an avalanche at virtually any point along the route would be disastrous - save this one for when conditions are safe and you are confident that you can pass through steep terrain on all aspects in (relative) safety.", recommended_time: "March-April", positive_elevation: 1101, negative_elevation: 1905, equipments: ["Skis", "Ropes", "Arva", "Clothes", "Crampons", "Ice Axe", "Skins"])
