...
couloir_du_trappier = Trip.new(name: "Couloir du Trappier", location: "Chamonix", subtitle: "A large and very attractive couloir in plain view from Chamonix", start_lat: 45.873266989365206, start_long: 6.7792742326855695, end_lat: 45.887944288551815, end_long: 6.813335940241811, kilometers: 10.4, duration: "6-7 hours", difficulty: 4, description: "The Trappier is a stunning and broad couloir of moderate steepness, highly visible from the Chamonix town center. With 800 meter slopes averaging 38 degrees (maximum 45 for a short section) and a predominantly shady aspect, this line simply calls out to be skied. However, a word of caution; both the approach and descent are in serious avalanche terrain with significant terrain trap hazards. A good understanding of the snowpack and thorough assessment of the conditions are needed before venturing out on this route.", recommended_time: "February-March", positive_elevation: 1396, negative_elevation: 2091, equipments: ["Skis", "Ropes", "Arva", "Clothes", "Crampons", "Ice Axe", "Skins"])
